...
phx_accidents <- 
  read_csv("data/phoenix_accidents.csv")
```
...
| road_length_shutdown | The length of the road extent affected by the accident (in miles)                                                                                          |
...
| special_condition    | Special condition that was recorded for the location of the accident: Traffic light/stop sign, Pedestrian crossing, Road/highway junction, Other, Unknown  |
...
phx_accidents %>%
  ...
  ggplot(aes(x = time, fill = severity2)) +
