...
# We didn't go over this in class, but notice that `position = "dodge"` is added to put the bars nex to each other. We're also no longer using `facet_wrap`. And I put the legend at the bottom by adding `theme(legend.position = "bottom")`.
