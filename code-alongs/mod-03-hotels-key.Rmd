...
- Contact Jessica (or the) and/or visit office hours!
...
hotels %>%
  filter(adr == max(adr) | adr == min(adr)) %>%
  select(adr, hotel, arrival_date_year, arrival_date_month, adults, is_canceled, children, babies)
