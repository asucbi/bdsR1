...
- HW 3 due date moved to January 31st (same date as when the lab is due). Part of the reason I'm doing this is that I need to create a lecture on something known as data reshaping using the `pivot_wider` and `pivot_longer` functions. You will need one of these functions for doing the HW. 

- Updates to Module 3 project folder - Will need to download new HW starter file with a simple terminal command

### Understanding where our data comes from

Today's dataset comes from the "R For Data Science" community. They used to put out a podcast called Tidy Tuesday that features some open dataset and a "community challenge" to do fun things with the dataset. 

- [Tidy Tuesday](https://github.com/rfordatascience/tidytuesday)

We will be working with a dataset from Week 7 of 2020 called "Hotel Bookings:" Learn more here:

- [Hotel Booksings](https://github.com/rfordatascience/tidytuesday/blob/master/data/2020/2020-02-11/readme.md)

### What to do when you cannot figure things out?

- Using the readings as a resource
- Take advantage of online resources, such as community forums
  - [Stats Exchange](https://stats.stackexchange.com/)
