...
How do 15-year-old students in various countries score on the same assessment of math performance, how do the scores differ between females and males^[note: that we call this variable gender and not sex as this term was used in the OECD PISA database], and how have the scores changed over time? Answering these questions (at a high level) is the focus of this analysis.
...
The data we're using originally come from the **learningtower** package. The package allows easy access to a subset of variables from the Programme for International Student Assessment (PISA) data collected for the years 2000-2018. PISA assesses the extent to which 15-year-old students have acquired some of the knowledge and skills that are essential for full participation in society, and how well they are prepared for lifelong learning in the areas of reading, mathematical and scientific literacy. In 2018, PISA involved 79 countries and 600,000+ students worldwide.
...
Let's create a data visualization that displays how students performed in math for eight countries, breaking the scores down by sex. We can easily change which countries are being plotted by changing which countries the code below `filter`s for. Note that the country name should be spelled and capitalized exactly the same way as it appears in the data. See the [Appendix](#appendix) for a list of the countries in the data.
...
```{r, plot-math-change, eval = FALSE, echo = FALSE, message = FALSE}
