...
- The $\beta$ coefficient has meaningful units: kg/cm
...
- Now the `weight` coefficient represents the change in weight for a change in height in units of standard deviation
