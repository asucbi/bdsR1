---
title: "HW 08 - Football, brains, and cognition"
...
In this lab we will explore a subset of the data reported in this paper published in the *Journal of American Medical Association* (JAMA). [add the paper link]

The data can be found in the `data` folder as `filename.csv`.
...
10. Create regression diagnostics plots for `fit2`. You may use the functions given to you in lab 2.  
Plot:  
