...
![](img/daniel-cheung-ZqqlOZyGG7g-unsplash.jpg){fig-align="center" width=100%}
...
- Among the two most common themes of Lego sets purchased (see Question 2), what is the most common subtheme?
...
::: callout-tip
You will need to consider quantity of purchases.
:::
...
- Which area code has spent the most money on Legos?
  - Remember an area code is the first 3 digits of a phone number.

::: callout-tip
You're going to have to manipulate a string to create a new variable. The [`str_sub()`](https://stringr.tidyverse.org/reference/str_sub.html) function will be helpful here! Read the help documentation, google search it, hack away. The best way to learn. 
:::

### Exercise 9

- Come up with a question you want to answer using these data, and write it down.
