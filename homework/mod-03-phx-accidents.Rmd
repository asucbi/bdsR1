...
```{marginfigure}
Notice that the `read_csv` function is able to retrieve these file just as long as you give it the correct URL to the repository. 
```
...
The variable descriptions are as follows. Read through them, try to get a sense of what you have available:
