...
![](img/1024px-Clemson_and_Temple.jpg){fig-align="center" width=100%}
...
Go to the course Posit Cloud Workspace and locate the folder for the homework assignment, which should be named `Assignments: Module 8`.

First, open the R Markdown document `mod-08-hw.Rmd` and Knit it.
