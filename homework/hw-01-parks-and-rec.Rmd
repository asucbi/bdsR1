...
-   you are set up in the Posit Cloud space; if you are not, then you did not complete the prerequisite for this assignment. Please go back to [Prerequisites] and complete it.
...
For Week 1 only, you need to follow the instructions on the Canvas page: "Info on Posit Cloud (for HWs, Labs, and All Analyses)" to get the homework .RMD file loaded into your Posit Cloud/RStudio environment. 
