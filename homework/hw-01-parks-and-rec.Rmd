...
This assignment assumes that you have completed all the steps in the Canvas pages: "Posit Cloud: Setting up for Week 1" and on "Posit Cloud: Editing and Preparing for Submission" to get yourself set up on Posit Cloud. If you haven't yet done so, please pause and complete it before continuing.
...
For Week 1 only, you need to follow the instructions on the Canvas page: "Posit Cloud: Setting up for Week 1" to get the homework .RMD file loaded into your Posit Cloud/RStudio environment. 
