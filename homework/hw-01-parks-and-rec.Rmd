...
This assignment assumes that you have completed all the steps in the Canvas page: "Info on Posit Cloud (for HWs, Labs, and All Analyses)" to get yourself set up on Posit Cloud. If you haven't yet done so, please pause and complete it before continuing.
...
-   **Posit Cloud** The online service for accessing RStudio. 
    ...
    -   In this course, assignment instructions you work on (HWs, Labs, Project) will be available on Canvas. The "starter" documents needed to complete each assignment will typically be available on Posit Cloud; however, for Week 1, you need to download from the instruction page in Canvas. 
...
-   are a member of the course Posit Cloud space; if you are not, then you did not complete the prerequisite for this assignment. Please go back to [Prerequisites] and complete it.

# Workflow

For each assignment in this course you will go to a shared folder in Posit Cloud that contains starter documents (except for Week 1 where you will upload the document yourself). You will build upon this document when working on your assignment. In Posit Cloud/RStudio you will edit them, run them, view your results, and interpret them. In other words, all data analysis will happen in RStudio. 

Lets walk through some of the steps that will get you ready for analysis. 

# Hello RStudio!

For Week 1 only, you need to follow the instructions on the Canvas page: "Info on Posit Cloud (for HWs, Labs, and All Analyses)" to get the HW .RMD file loaded into your Posit Cloud/RStudio environment. 
...
When you're all done, it's now time to do the final knit to submit this assignment on Canvas. Remember, you want to knit as a PDF and submit the generated PDF document for grading! If you cannot remember how, please watch my little video and read the instructions on the Canvas page: "Info on Posit Cloud (for HWs, Labs, and All Analyses)"
