...
-   **bdsdata**: a package that contains various data sets for this course (Behavioral Data Science I)
...
🧶 ✅ ⬆️ *Write your answer in your R Markdown starter document under Exercise 1, knit the document as a "github_document" (default output in the YAML).*

2.  Again, according to the data dictionary, how many rows of data do we have for this dataset?

🧶 ✅ ⬆️ *Write your answer in your R Markdown starter document under Exercise 2, knit the document as a "github_document" (default output in the YAML).*
...
🧶 ✅ ⬆️ *Write your answer in your R Markdown starter document under Exercise 3, knit the document as a "github_document" (default output in the YAML).*
...
parks_rec %>%
  ...
  count(sort = TRUE)
```
🧶 ✅ ⬆️ *Write your answer in your R Markdown starter document under Exercise 4, knit the document as a "github_document" (default output in the YAML).*
...
Now is a good time to do the final knit to submit this assignment on Canvas. Remember, you want to knit it as a PDF by changing the YAML. 
