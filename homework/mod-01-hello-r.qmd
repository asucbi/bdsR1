...
![](img/dino-unsplash.jpg){fig-align="center" width=65%}
...
![](img/yaml-raw-to-rendered.png){fig-align="center" width=100%}

### Packages

In this homework we will work with two packages: **datasauRus** which contains the dataset we'll be using and **tidyverse** which is a collection of packages for doing data analysis in a "tidy" way.
...
:::callout-important
Add your responses to the starter file for this homework.
:::

---

**Next,** let's take a look at what these datasets are.
...
The other Dozen were generated using something called "simulated annealing."[^hw-01-hello-r-1]
:::
...
::: callout-note
If this seems like a lot, it is. You will learn about the philosophy of building data visualizations in layer in detail next week. For now, follow along with the code that is provided.
:::
...
::: callout-tip
Facet by the dataset variable, placing the plots in a 3 column grid, and don't add a legend. See code below for examples of how to do it. 
:::
...
![](img/fig-resize-global.png){fig-align="center" width=50%}
...
![](img/fig-resize-local.png){fig-align="center" width=75%}
...
![](img/theme-highlight.png){fig-align="center" width=50%}
...
One option is to select the "Knit" icon's dropdown menu and then select the option for knitting to PDF. When you do so, a PDF document should be automatically generated in the same folder where you found the HW starter file.

![](img/knit2.png){fig-align="center" width=100%}
...
[^hw-01-hello-r-1]: Source: Matejka, Justin, and George Fitzmaurice. "Same stats, different graphs: Generating datasets with varied appearance and identical statistics through simulated annealing." Proceedings of the 2017 CHI Conference on Human Factors in Computing Systems. ACM, 2017.
