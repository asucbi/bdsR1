...
1.  Dataset and research question proposal pitch - in-class, October 8th and 10th
2.  Proposal document - due October 11th (Friday)
3.  Proposal peer review - in-class, October 17th
4.  Analysis notebook - due November 27th (Wednesday)
5.  Peer Review - in-class, December 3rd and 5th

### 1. Dataset and research question proposal

Students will be randomly paired to meet 1:1 and each give their “2-minute pitch” of their data analysis plan. After the pitch each pair will discuss the idea, think of possible issues, weaknesses, as well as other ideas or inspirations. Then you’ll trade roles and every 10 minutes we will swap partners and repeat.
...
-   **Section 2 - Data:** Place your data in the /data folder, make sure the notebook includes the output of glimpse() or skim() of your data frame that shows the dimensions of the dataset and the variables you are interested in.

-   **Section 3 - Research question:** What are the research questions that you will use this data to help answer? Remember, your research questions should have something to do with a meaningful human behavior or psychological process.
...
-   **Section 4 - Analysis plan:** For each of your research questions, include:
    ...
    -   Describe the visualizations you will make along with some explanation on how they help you learn more about your data.
    -   What results from these visualizations would help to support different hypotheses?

Each section should be no more than 1 page. You can check a print preview to confirm length.
...
You will prepare a final RMarkdown notebook as a presentation of your project using a provided template (we will provide it to you). You should organize descriptions as bullet points (like you would for a powerpoint) and include outputs and figures within the notebook. 
