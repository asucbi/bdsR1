...
:::green
**IMPORTANT** This example with Tucker Carlson was based on whatever was the lead post when this assignment was originally created. The PolitiFact website has obviously added new posts since then and you will be seeing something different. But all the steps below work exactly in the same way. 
:::
...
library(knitr)
library(kableExtra)
fact_checks_lie <- read_csv("fact_checks_lie.csv") # <<< you just created this .csv in the R scripts
fact_checks_truth <- read_csv("fact_checks_truth.csv") # <<< you just created this .csv in the R scripts
