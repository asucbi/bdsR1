...
Go to the Posit Cloud and locate the project folder for "Module 5 - Lab" and open the starter R Markdown document.
...
# Where should you be looking for it?
staff <- ___ 
```
...
Write up the changes/decisions you made as bullet points (i.e., as a list).
...
Implement the changes you proposed in the previous exercise. That is, create an improved figure! Your new figure should be substantially different from what we started with. 
...
:::green
You might find it helpful to load in the data and `glimpse` it or `View` it to see what you're working with in greater depth.
:::
...
Create a new data visualization for these data that implements the improvements you proposed in the previous exercise (or many of them as you can).
