...
Go to the Posit Cloud and locate the project folder for "Module 5 - Lab and HW" and open the starter R Markdown document.
...
You can find out more about the datasets by inspecting their documentation [here](https://rstudio-education.github.io/dsbox/reference/instructors.html) and [here](https://rstudio-education.github.io/dsbox/reference/fisheries.html). It might be a good idea to quickly do so now to get a better feel of what you're dealing with. 
