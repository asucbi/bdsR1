...
-   Look for the course workspace called "BDS in R | F26"
...
:::green
**NOTE:** When you knit for the first time, your browser might get upset if you have an ad blocker on. Watch the video "How to prepare and submit a submission in Posit Cloud for Canvas" in the Module "Important Resources and HOWTOs" if you're having trouble. 
:::
...
-   **bdsdata**: a package (previous BDS instructors created) that contains various data sets for this course (Behavioral Data Science I)
...
3.  Who are the three most mentioned show characters across all seasons? To do this you will need to count the frequencies of each character and display the results in descending order of frequency. The following code does exactly that. 
...
Now I'm going to give you a set of instructions you need to plug into your document (you can copy, paste, and run the following code). These will help you answer Exercise 4 (which is coming up next).  
...
**For Exercise 5, respond to the question below:**
