...
Work together to complete these exercises. Each person in your group should get a chance to take the lead for an exercise. You don't have to switch at     each exercise, you can find your a cadence that works for your team and stick to it. 
...
To help with this exercise, we can first print out the country variable in each by indexing the data frames with the `$` operator. First, squint at these and see if you can find any differences.
...
If you're going cross-eyed, you can also try using the `%in%` operator to see which of the countries from one dataset are in the list of countries from the other dataset.
