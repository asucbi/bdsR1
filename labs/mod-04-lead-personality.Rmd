...
survey <- read_csv("labs/data/eu-pers-survey.csv")
...
eudata <- read_csv("labs/data/eu-country-data.csv")
...
7. Modify the code above to color the map by the average agreeableness in that country. What you produce should look like so:
