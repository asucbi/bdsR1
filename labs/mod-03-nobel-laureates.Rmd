...
-   Collaborating within R Studio server and generating final RMarkdown report
...
Go to the course RStudio Cloud Workspace and locate the folder for the lab assignment, which should be named `lab-03-nobel-laureates-starter`.
